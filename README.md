...
```
https://raw.githubusercontent.com/pikacnu/mc-color-data/v1/<version>/blocks/data.min.json
```
...
This project has taken inspiration from [Aeldrion/IrisDataGen](https://github.com/Aeldrion/IrisDataGen) and [misode/mcmeta](https://github.com/misode/mcmeta) and [mcbookshelf/mcdata](https://github.com/mcbookshelf/mcdata)
